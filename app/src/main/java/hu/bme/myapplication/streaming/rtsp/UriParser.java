...
package hu.bme.myapplication.streaming.rtsp;

import static hu.bme.myapplication.streaming.SessionBuilder.AUDIO_AAC;
import static hu.bme.myapplication.streaming.SessionBuilder.AUDIO_AMRNB;
import static hu.bme.myapplication.streaming.SessionBuilder.AUDIO_NONE;
import static hu.bme.myapplication.streaming.SessionBuilder.VIDEO_H263;
import static hu.bme.myapplication.streaming.SessionBuilder.VIDEO_H264;
import static hu.bme.myapplication.streaming.SessionBuilder.VIDEO_NONE;
...
import hu.bme.myapplication.streaming.MediaStream;
import hu.bme.myapplication.streaming.Session;
import hu.bme.myapplication.streaming.SessionBuilder;
import hu.bme.myapplication.streaming.audio.AudioQuality;
import hu.bme.myapplication.streaming.video.VideoQuality;
